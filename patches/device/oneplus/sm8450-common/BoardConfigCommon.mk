...
TARGET_SUPPORTS_64_BIT_APPS_ONLY := true
...
BOARD_ONEPLUS_DYNAMIC_PARTITIONS_SIZE := 9663676416
BOARD_SUPER_PARTITION_GROUPS := oneplus_dynamic_partitions
BOARD_SUPER_PARTITION_SIZE := 14763950080
...
KERNEL_DEFCONFIG := udon_defconfig
BOARD_USES_GENERIC_KERNEL_IMAGE := true
BOARD_INCLUDE_DTB_IN_BOOTIMG := true
TARGET_NEEDS_RECOVERY_AS_BOOT := true
